        ...
        with st.spinner("计算预测结果..."):
            try:
                ...
                fig = go.Figure(go.Indicator(
                    ...
                    domain = {'x': [0, 1], 'y': [0, 1]},
                    title = {'text': "", 'font': {'size': 14, 'family': 'SimHei', 'color': 'black', 'weight': 'bold'}},
                    gauge = {
                ...
                try:
                    with st.spinner("正在生成SHAP解释图..."):
                        ...
                        # 手动修改标题 - 使用英文避免中文显示问题
                        plt.title("Feature Impact on Prediction", fontsize=12, fontname='Arial', fontweight='bold', color='black')
